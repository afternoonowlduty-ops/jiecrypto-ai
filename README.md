...
## Deploying to jiecrypto.ai

This is a plain Node app — deploy anywhere Node 18+ runs (Render, Railway, Fly.io, a VPS…). Set `AGNES_API_KEY` as an environment variable on the host, point the `jiecrypto.ai` DNS A/CNAME record at it, and enable HTTPS.
